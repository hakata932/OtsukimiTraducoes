---
title: FAQ
description: Perguntas frequentes sobre a Otsukimi e nossas traduções de White Album 2 e obras da Leaf em PT-BR.
---

#### O que é a Otsukimi?

Somos um grupo de fãs (fansub) dedicado à tradução de White Album 2 e obras da Leaf para o português do Brasil. Saiba mais na página [Quem somos?](/quem-somos).

#### Os patches são pagos?

Não! Nossos patches são completamente gratuitos, sem fins lucrativos, sem anúncios e sem redirecionamentos. Feitos de fã para fã.
...
Na página do projeto: [White Album 2](/projetos/whitealbum2). Lá você encontra os passos de instalação, o progresso da tradução e as perguntas frequentes específicas do patch.
